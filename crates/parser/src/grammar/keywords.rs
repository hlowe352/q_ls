...
const BUILTIN_INFIX: &[&str] = &[
    "and", "asof", "bin", "binr", "cor", "cov", "cross", "div", "dsave", "each", "ema", "except",
    "fby", "ij", "ijf", "in", "insert", "inter", "like", "lj", "ljf", "lsq", "mavg", "mcount",
    "mdev", "mmax", "mmin", "mmu", "mod", "msum", "or", "peach", "pj", "scov", "setenv", "ss",
    "sublist", "sv", "uj", "ujf", "union", "upsert", "vs", "wavg", "within", "wsum", "xasc",
    "xbar", "xcol", "xcols", "xdesc", "xexp", "xkey", "xlog", "xprev", "xrank",
];
...
mod tests {
    ...
    fn recognises_core_keywords() {
        for kw in [
            "mmu", "lsq", "in", "within", "each", "peach", "div", "mod", "wavg", "wsum", "cor",
            "cov", "scov", "cross", "union", "inter", "except", "sublist", "vs", "sv", "ss",
            "like", "mavg", "mmax", "mmin", "msum", "mdev", "mcount", "ema", "ij", "ijf", "uj",
            "ujf", "lj", "ljf", "asof", "pj", "insert", "upsert", "xasc", "xdesc", "xcol", "xcols",
            "xkey", "xprev", "xrank", "xbar", "xexp", "xlog", "dsave", "fby", "bin", "binr", "and",
            "or", "setenv",
        ] {
